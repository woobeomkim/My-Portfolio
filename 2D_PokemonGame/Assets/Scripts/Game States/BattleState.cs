...
public class BattleState : State<GameController>
{
    ...
    public override void Enter(GameController owner)
    {
        ...
        if (trainer == null)
        {
            ...
            battleSystem.StartBattle(playerParty, wildPokemonCopy, trigger,weather: mapArea.Weather);
        }
        else
        {
            var trainerParty = trainer.GetComponent<PokemonParty>();
            battleSystem.StartTrainerBattle(playerParty, trainerParty,weather: mapArea.Weather, unitCount: trainer.BattleUnitCount);
        }
